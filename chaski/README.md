...
| **License** | `apache-2.0` |
| **HF Jobs** | `6a91bf10` was the live `report_to=none` job (files now on repo). `6a91bb7c` ERROR after upload. |
| **Status** | CUTTING. Files exist on Hub. Evals none-this-run. MEASURED train_loss ~1.7839 is not an eval. |
...
**Evaluation:** none-this-run. MEASURED train_loss ~1.7839 is a train metric, not an eval. Quality is UNKNOWN. Λ is Conjecture 1. Hub README is the job’s card; this GitHub copy is not recut onto Hub.
