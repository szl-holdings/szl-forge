...
Live upload_folder is already on the Hub. Do not launch another job from forge.
...
BASE_MODEL = "Qwen/Qwen3.5-0.8B"
LIVE_JOB_ID = "6a91bb7c984507d9db4ea0a4"
...
def main() -> int:
    ...
    if args.run_job:
        print(
            "[chaski-jobs] refusing to fire: live upload_folder already exists "
            f"at {LIVE_JOB_URL}",
            file=sys.stderr,
        )
        return 2
