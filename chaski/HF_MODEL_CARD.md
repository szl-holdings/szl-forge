...
**Named-N MEASURED fail** on live Chaski `1c55df8` (2026-08-28). Receipt: `eval_report.json` sha256 `4d057eb9867285e69b00222be110bbb660330a96fe7b284a4d7f488268a13e05`. `json_draft` **0/5**. `adversarial_refusal` **2/6**. Not a pass. Quality is ROADMAP (prose). Train loss MEASURED `1.783925924450159` is a train metric, not an eval. `publication_eligible: false`.
...
- Narrow curriculum. Controller required. Λ = Conjecture 1. Trust ceiling 0.97. `publication_eligible: false`. CUTTING. Weights AVAILABLE. Named-N MEASURED fail is not a publish.
