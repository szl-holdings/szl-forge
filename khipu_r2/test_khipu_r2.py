...
class KhipuR2KitTests(unittest.TestCase):
    ...
    def test_status_receipt_stamps_live_hub_not_empty(self) -> None:
        ...
        self.assertIn(HUB_JOB_ID, completed.stdout)
        ...
        self.assertIn("5/5", completed.stdout)
        ...
        self.assertEqual("5/5", receipt["hub_grounding"])
        self.assertEqual(5, receipt["hub_grounding_correct"])
        self.assertEqual(5, receipt["hub_grounding_total"])
        ...
        self.assertEqual(32, receipt["lora_r"])
        self.assertEqual(64, receipt["lora_alpha"])
    ...
    def test_eval_stamps_hub_three_of_six_and_not_this_run(self) -> None:
        ...
        self.assertEqual("5/5", report["hub_grounding"])
    ...
    def test_serve_check_discloses_base_model_and_hub_adapter(self) -> None:
        ...
        self.assertEqual(HUB_JOB_ID, payload["hub_job_id"])
    ...
    def test_jobs_launcher_refuses_to_fire(self) -> None:
        ...
        self.assertIn(HUB_JOB_ID, dry.stdout)
