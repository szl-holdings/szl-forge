...
| [`KHIPU-R2`](./khipu_r2/) | **Separate SKU (ROADMAP recipe)** | Jobs UNKNOWN this checkout; `publication_eligible: false` | Successor kit for the 2/6 abstain blocker. Does **not** overwrite signed `SZL-Khipu-1.5B`. |
