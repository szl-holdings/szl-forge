...
| Fall 2026 original cuts (`SZLHOLDINGS/{chaski,qantu,waman,chakana,tinku}`) | **GitHub recipes + honest job stamps** | Chaski CUTTING (attempt 3 receipt MEASURED, attempt 4 ERROR no safetensors, live `6a91bf10` report_to=none). Qantu/Waman SKIP. Chakana/Tinku Jobs UNKNOWN. | Hub cards are not weights. No Qantu/Waman trainers. KILLINCHU-EYE is a Waman alias. See [`chaski/README.md`](./chaski/README.md). |
