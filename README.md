...
| [`CHASKI-R2`](./chaski_r2/) | **Separate SKU (CHAWPI silhouette)** | Jobs UNAVAILABLE this checkout; evals none-this-run; `publication_eligible: false` | JSON-draft + REFUSE/ABSTAIN kit on disclosed `Qwen/Qwen3.5-0.8B`. Does **not** overwrite live `SZLHOLDINGS/chaski`. Not 5050. |
