...
| Fall 2026 original cuts (`SZLHOLDINGS/{chaski,qantu,waman,chakana,tinku}`) | **GitHub recipes + honest job stamps** | Chaski CUTTING (attempt 3 receipt MEASURED, weights UNAVAILABLE; live upload_folder `6a91bb7c`). Qantu/Waman SKIP. Chakana/Tinku Jobs UNKNOWN. | Hub cards are not weights. No Qantu/Waman trainers. KILLINCHU-EYE is a Waman alias. See [`chaski/README.md`](./chaski/README.md). |
