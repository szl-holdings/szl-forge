...
| [`KHIPU-R2`](./khipu_r2/) | **Separate SKU** | Hub job `6a91bf11` COMPLETED; adapter 147.8MB AVAILABLE; abstain MEASURED 3/6 (not a pass). This-kit jobs UNKNOWN; this-SKU evals not-this-run; `publication_eligible: false`. | Does **not** overwrite signed `SZL-Khipu-1.5B`. Lab stays signed Khipu GGUF. |
