...
| Fall 2026 original cuts (`SZLHOLDINGS/{chaski,qantu,waman,chakana,tinku}`) | **GitHub recipes + honest job stamps** | Chaski CUTTING (`6a91bf10` COMPLETED, weights AVAILABLE; evals none-this-run; `6a91bb7c` ERROR). Qantu/Waman SKIP. Chakana/Tinku Jobs UNKNOWN. | Files on Hub are not an eval. No Qantu/Waman trainers. KILLINCHU-EYE is a Waman alias. Hub README is not recut from this checkout. See [`chaski/README.md`](./chaski/README.md). |
