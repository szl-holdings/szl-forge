...
def test_chaski_cards_make_no_unverified_uniqueness_or_leadership_claim() -> None:
    for relative in ("chaski/card/README.md", "chaski-5050/card/README.md"):
        card = _card(relative)
        ...
        assert "no uniqueness claim is made." in lowered


def test_chaski_cards_point_to_their_own_source_directories() -> None:
    ...
    assert "szl-holdings/szl-forge/tree/main/chaski-5050/card" in chaski_5050
