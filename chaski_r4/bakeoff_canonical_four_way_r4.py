...
# LOCAL-ONLY R4 BAKEOFF COPY:
# Preserve canonical gate paths from tracked chaski, not this local r4 folder.
...
def run_bakeoff(args: argparse.Namespace) -> dict[str, Any]:
    ...
    specs = [
        ...
        },
        {
            ...
            "adapter": first_adapter([Path(args.chaski_r4_adapter)]) if args.chaski_r4_adapter else None,
            "does_not_overwrite": PARENT_HUB,
            "hub_id_declared_only": True,
            "local_only": True,
        },
...
def main() -> int:
    ...
    parser.add_argument("--chaski-r4-adapter", default=None)
