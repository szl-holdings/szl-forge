...
<p align="center">
  <img src="https://raw.githubusercontent.com/szl-holdings/szl-forge/main/szl-lambda-gate/card/holo-banner.svg" alt="szl-lambda-gate — the advisory gate as a hologram: Λ over a threshold, one zeroed axis fails the gate" width="100%"/>
</p>
...
**The cut, in one line:** a gate that advises, imports, and never claims the theorem.
