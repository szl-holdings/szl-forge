...
from frontier.asyncgrpo_lora_install import prepare_job_local, read_direct_url
    ...
    *,
    ...
    try:
        ...
        gpu_attempt = try_gpu_sync_paths(
            ...
            workspace / "gpu",
            execute=execute_gpu,
            venv_python=str(job_local.get("venvPython")) if isinstance(job_local, dict) and job_local.get("venvPython") else None,
        )
        gpu_negatives = try_gpu_negative_paths(probe, workspace / "gpu-negatives", execute=execute_gpu)
